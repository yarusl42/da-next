...
import framer from "@/assets/about/framer.jpg";
import windsurf from "@/assets/about/windsurf.jpg";
import google from "@/assets/about/google.jpg";
        ...
        >
          ...
          <ul className="space-y-0 max-w-[480px] max-[768px]:max-w-3xl">
            <li className="flex items-start gap-4 py-5 border-b border-foreground/20">
              <img src={figma.src} alt="Figma" className="rounded-xl w-14 h-14 object-cover flex-shrink-0" />
            ...
            <li className="flex items-start gap-4 py-5 border-b border-foreground/20">
              <img src={react.src} alt="React" className="rounded-xl w-14 h-14 object-cover flex-shrink-0" />
              <div className="flex-1">
            ...
            <li className="flex items-start gap-4 py-5 border-b border-foreground/20">
              <img src={framer.src} alt="Framer" className="rounded-xl w-14 h-14 object-cover flex-shrink-0" />
              <div className="flex-1">
            ...
            <li className="flex items-start gap-4 py-5 border-b border-foreground/20">
              <img src={windsurf.src} alt="Windsurf" className="rounded-xl w-14 h-14 object-cover flex-shrink-0" />
              <div className="flex-1">
            ...
            <li className="flex items-start gap-4 py-5 border-b border-foreground/20">
              <img src={google.src} alt="Google" className="rounded-xl w-14 h-14 object-cover flex-shrink-0" />
              <div className="flex-1">
